...
@columns struct Maturity{MoMo,MoMoD,F,Mo} <: AbstractMaturity
    # Field            | Default         | Unit            | Prior           | Limits      | _ | Description
...
@CatabolismCN struct CatabolismCN{} <: AbstractCatabolism end
...
@columns struct Core{MoMo,GMo} <: AbstractCore
    ...
    y_E_EC::MoMo | 0.7   | mol*mol^-1 | Gamma(2.0, 2.0) | [0.0, 1.0]   | _ | "From C-reserve to reserve, using nitrate"
    y_E_EN::MoMo | 30.0  | mol*mol^-1 | Gamma(2.0, 2.0) | [0.0, 50.0]  | _ | "From N-reserve to reserve"
