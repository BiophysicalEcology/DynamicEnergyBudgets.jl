...
@mix @columns struct KAutophagy{Mo}
    ...
    K_autophagy::Mo | 0.000001 | mol        | Beta(2.0, 2.0) | [1e-8, 1e-4] | true | "Half saturation metabolic rate for reincorporation of tissues. Necessary to not break the laws of thermodynamics!"
end
