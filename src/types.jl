...
@SLA struct KooijmanSLAPhotosynthesis{MoMoS,MoL,MoMoS,μMoMS,MoMS} <: AbstractCAssim
    ...
    J_L_K::MoMS        | 1000.0 * parconv  | u"mol*m^-2*s^-1"   | Gamma(2.0, 2.0) | [0.0, 1000.0]   | "Half-saturation flux of useful photons"
...
@columns struct KooijmanNH4_NO3Assim{μMoMS,F,MoMo,MoL} <: AbstractNH4_NO3Assim
    ...
    y_E_CH_NH::MoMo  | 1.25    | u"mol*mol^-1"       | Gamma(1.25, 1.0) | [0.0, 4.0]    | "From roots C-reserve to reserve using ammonia"
    K_NH::MoL        | 0.01    | u"mol*L^-1"         | Gamma(0.01, 1.0) | [0.0, 10.0]   | "Half-saturation concentration of ammonia"
    K_NO::MoL        | 0.01    | u"mol*L^-1"         | Gamma(0.01, 1.0) | [0.0, 10.0]   | "Half-saturation concentration of nitrate"
...
@columns struct NAssim{μMoS,MoL} <: AbstractNAssim
    ...
    K_H::MoL       | 10.0    | u"mol*L^-1"         | Gamma(10.0, 1.0) | [0.0, 100.0]  | "Half-saturation concentration of water"
end
...
@columns struct Maturity{MoMoD,F,Mo}
    ...
    M_Vmat::Mo         | 10.0            | u"mol"             | Beta(2.0, 2.0)  | [0.0, 20.0]  | "Shoots structural mass at start reproduction" # TODO: isn't this variable/seasonally triggered?  w_M::GMo           | 25.0            | u"g*mol^-1"        | Beta(2.0, 2.0)  | [0.0, 1.0]   | "Mol-weight of shoot maturity reserve:"
end

" Model parameters that vary between organs "
@mix @columns struct Params{A,S,Al,Ma,Tr,F,Mo,MoMoD,MoMo}
    # Field            | Default         | Unit               | Prior           | Limits       | Description
    ...
    y_E_CH_NO::MoMo    | 1.5             | u"mol*mol^-1"      | Gamma(2.0, 2.0) | [0.0, 4.0]   | "From C-reserve to reserve, using nitrate"
    y_E_EN::MoMo       | 0.5             | u"mol*mol^-1"      | Gamma(2.0, 2.0) | [0.0, 4.0]   | "From N-reserve to reserve"
...
@Params struct ParamsCN{} end

@Params struct ParamsCNE{MoMoD,MoMo}
...
@columns @flattenable struct SharedParams{Fb,C,MoMo,GMo}
    ...
    n_N_P::MoMo     | _     | 0.1                  | u"mol*mol^-1" | Gamma(2.0, 2.0) | [0.0, 1.0]   | "N/C in product (wood)"
    n_N_V::MoMo     | _     | 0.15                 | u"mol*mol^-1" | Gamma(2.0, 2.0) | [0.0, 1.0]   | "N/C in structure" # Shouldnt this be identical to the reserve?
    ...
    n_N_EC::MoMo    | _     | 0.0                  | u"mol*mol^-1" | Gamma(2.0, 2.0) | [0.0, 1.0]   | "N/C in C-reserve"
    n_N_EN::MoMo    | _     | 1.0                  | u"mol*mol^-1" | Gamma(2.0, 2.0) | [0.0, 20.0]  | "N/C in N-reserve"
